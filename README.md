...
# Master Page and Transaction Page

The page which has the primary key and use it directly is said to be as Master page and if the page made a transaction with the help of the foreign key is said to be as Transaction page
